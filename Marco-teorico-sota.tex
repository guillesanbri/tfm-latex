...
\todo[inline]{Figura similar a la del paper}

\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{imagenes/performer.png} 
\captionsetup{width=.8\linewidth}
\caption{Temp TODO}
\label{fig:performer}
\end{figure}

\todo[inline]{Paper performer: \url{https://arxiv.org/pdf/2009.14794.pdf}}
