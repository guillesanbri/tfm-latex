...
\def\maketitle{
  ...
  % Cabecera ----------------
    \begin{center}%
    	...
    	\includegraphics[height=3cm]{imagenes/escudoUVA} \hfill
    	\includegraphics[height=3cm]{imagenes/escudoInfor.pdf} \hfill
    	\includegraphics[height=3cm]{imagenes/escudoEIIVA.png} \hfill
    \end{center}%
  \vfill
    \begin{center}%
