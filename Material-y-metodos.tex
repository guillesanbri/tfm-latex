...
\todo{Poner links, citas, etc. Repasar todo lo que hay escrito. No usados aún (?): (onnx, c++)}

\subsubsection{Software}

\todo{Citar todo, mencionar las licencias que tiene cada software}
...
\subparagraph{Conjuntos de entrenamiento, validación y evaluación}:
